...
class Line:
    ...
    def __init__(self, document_id, page_nr, line_nr, text, x, y, width, height, label=None, n_lines_below=None, merged=[]) -> None:
    ...
    def merge(self, line, number):
        ...
        return Line(self.document_id, self.page_nr, number, text, x, y, width, height, label=-1, n_lines_below=n_lines_below, merged=merged)